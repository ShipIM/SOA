...
public class ProductController {
    ...
    private void validateCreateProductRequest(CreateProductRequest request) {
        if (request == null) {
            throw new ValidationErrorException("CreateProductRequest cannot be null", "CreateProductRequest");
        }

        if (request.getName() == null || request.getName().trim().isEmpty()) {
            throw new ValidationErrorException("Product name cannot be null or empty", "Product name");
        }

        if (request.getCoordinates() == null) {
            throw new ValidationErrorException("Coordinates cannot be null", "Coordinates");
        }
        validateCreateCoordinatesRequest(request.getCoordinates());

        if (request.getUnitOfMeasure() == null) {
            throw new ValidationErrorException("Product unit of measure cannot be null or illegal value", "Product unit of measure");
        }

        if (request.getPrice() <= 0) {
            throw new ValidationErrorException("Price must be greater than 0", "Price");
        }
    ...
    private void validateCreateCoordinatesRequest(CreateCoordinatesRequest coordinates) {
        ...
        if (coordinates.getX() > 39) {
            throw new ValidationErrorException("Coordinates x must be less than or equal to 39", "Coordinate x");
        }

        if (coordinates.getY() > 905) {
            throw new ValidationErrorException("Coordinates y must be less than or equal to 905", "Coordinate y");
        }
    }

    private void validateCreatePersonRequest(CreatePersonRequest person) {
        if (person == null) {
            throw new ValidationErrorException("Person cannot be null", "Person");
        }

        if (person.getName() == null || person.getName().trim().isEmpty()) {
            throw new ValidationErrorException("Person name cannot be null or empty", "Person name");
        }

        if (person.getHeight() <= 0) {
            throw new ValidationErrorException("Person height must be greater than 0", "Person height");
        }

        if (person.getEyeColor() == null) {
            throw new ValidationErrorException("Person eye color cannot be null or illegal value", "Person eye color");
        }

        if (person.getNationality() == null) {
            throw new ValidationErrorException("Person nationality cannot be null or illegal value", "Person nationality");
        }
    }

    private void validateUpdateProductRequest(UpdateProductRequest request) {
        if (request == null) {
            throw new ValidationErrorException("UpdateProductRequest cannot be null", "UpdateProductRequest");
        }
