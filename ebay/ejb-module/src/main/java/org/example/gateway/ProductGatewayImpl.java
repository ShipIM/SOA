...
public class ProductGatewayImpl implements ProductGateway {
    ...
    private final String baseUrl = "https://host.docker.internal:8080/first-service/api/v1";

    public ProductGatewayImpl() throws NoSuchAlgorithmException, KeyManagementException {
        var noopTrustManager = new TrustManager[]{
        ...
        try {
            ...
            throw new ServiceUnavailableException("can't connect to the server");
        }
    }
    ...
    public void updateProduct(Product product) {
        ...
        var target = this.target.path("/products/" + product.getId());
