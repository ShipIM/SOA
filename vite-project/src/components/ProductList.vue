  ...
  methods: {
    fetchProducts() {
      ...
      const endpoint = sort === null
        ? `https://localhost:8090/api/v1/products/?page=${this.page}&size=${this.size}${filters}`
        : `https://localhost:8090/api/v1/products/?page=${this.page}&size=${this.size}&sort=${sort}${filters}`;
